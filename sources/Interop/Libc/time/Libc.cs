...
namespace TerraFX.Interop
{
    public static unsafe partial class Libc
    {
        ...
        [DllImport("libc", ExactSpelling = true)]
        public static extern int timer_create([NativeTypeName("clockid_t")] int __clock_id, [NativeTypeName("struct sigevent *__restrict")] sigevent* __evp, [NativeTypeName("timer_t *__restrict")] void** __timerid);
