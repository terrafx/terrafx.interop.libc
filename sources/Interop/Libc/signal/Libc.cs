...
namespace TerraFX.Interop
{
    public static unsafe partial class Libc
    {
        ...
        [DllImport("libc", ExactSpelling = true)]
        public static extern int sigemptyset([NativeTypeName("sigset_t *")] sigset_t* __set);

        [DllImport("libc", ExactSpelling = true)]
        public static extern int sigfillset([NativeTypeName("sigset_t *")] sigset_t* __set);

        [DllImport("libc", ExactSpelling = true)]
        public static extern int sigaddset([NativeTypeName("sigset_t *")] sigset_t* __set, int __signo);

        [DllImport("libc", ExactSpelling = true)]
        public static extern int sigdelset([NativeTypeName("sigset_t *")] sigset_t* __set, int __signo);
        ...
        [DllImport("libc", ExactSpelling = true)]
        public static extern int sigandset([NativeTypeName("sigset_t *")] sigset_t* __set, [NativeTypeName("const sigset_t *")] sigset_t* __left, [NativeTypeName("const sigset_t *")] sigset_t* __right);

        [DllImport("libc", ExactSpelling = true)]
        public static extern int sigorset([NativeTypeName("sigset_t *")] sigset_t* __set, [NativeTypeName("const sigset_t *")] sigset_t* __left, [NativeTypeName("const sigset_t *")] sigset_t* __right);
        ...
        [DllImport("libc", ExactSpelling = true)]
        public static extern int sigpending([NativeTypeName("sigset_t *")] sigset_t* __set);
        ...
        [DllImport("libc", ExactSpelling = true)]
        public static extern int sigqueue([NativeTypeName("__pid_t")] int __pid, int __sig, [NativeTypeName("const union sigval")] sigval __val);
        ...
        public static readonly delegate* unmanaged<int, void> SIG_ERR = ((delegate* unmanaged<int, void>)(-1));

        [NativeTypeName("#define SIG_DFL ((__sighandler_t)  0)")]
        public static readonly delegate* unmanaged<int, void> SIG_DFL = ((delegate* unmanaged<int, void>)(0));

        [NativeTypeName("#define SIG_IGN ((__sighandler_t)  1)")]
        public static readonly delegate* unmanaged<int, void> SIG_IGN = ((delegate* unmanaged<int, void>)(1));

        [NativeTypeName("#define SIG_HOLD ((__sighandler_t) 2)")]
        public static readonly delegate* unmanaged<int, void> SIG_HOLD = ((delegate* unmanaged<int, void>)(2));
